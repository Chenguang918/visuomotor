...
protocol_order=str2num(subinfo{5});
...
list=randperm(trial);
% Nt
condition_index(list(1:50))=11;
condition_index(list(51:100))=21;
% Pd
condition_index(list(101:150))=12;
condition_index(list(151:200))=22;
% Opposite
condition_index(list(201:212))=13;
condition_index(list(213:225))=23;
% Samesite
condition_index(list(226:235))=14;
condition_index(list(236:250))=24;
%% cue&target array
...
for ntrial=1:trial
    ...
    ma=mod(stiindex,10);%to decide cue type; 3/8 type 1&3/8 type 2&2/8 type 1 
