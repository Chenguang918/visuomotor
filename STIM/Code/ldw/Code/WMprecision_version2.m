...
%% Body Program
    for iBlock = 1:Blocknum
         NetStation('Event', MarkerBlockBegin);
        WaitSecs(0.002);
          %outp(888, 0);
        for iTrial = 1:StimTrialNum
            ...
            NetStation('Event', MarkerFixation);
            WaitSecs(0.002);
            %outp(888, 0);
            ...
            if BLorBR_IDs(totaltrialnum) == 1  % Blue Left
                ...
                NetStation('Event', num2str(fix(StimIDs(1,totaltrialnum)/100)));
                WaitSecs(0.002);
                 %outp(888, 0);
            ...
            NetStation('Event', num2str(MarkerFixation));
            WaitSecs(0.002);
            %outp(888, 0);
       ...
       %             Screen('FrameOval',wPtr,StimColor,LocBG,WideBar/4);
            ...
            NetStation('Event', num2str(MarkerRetrocue));
            WaitSecs(0.002);
            %outp(888, 0);
            ...
            NetStation('Event', num2str(testClr)); %!!!!!!!!!!!!!!!!!
            WaitSecs(0.002);
            %outp(888, 0);
            ...
            if ( difangle <= 10 && difangle >= -10)
                NetStation('Event', MarkerCorrectResponse);
                WaitSecs(0.002);
                %outp(888, 0);
                Correctnum = Correctnum +1;
                Data(totaltrialnum).Feedback = 1;
            elseif difangle == 999
                NetStation('Event', MarkerNoResponse);
                WaitSecs(0.002);
                %outp(888, 0);
                Noresponsenum = Noresponsenum +1;
                 Data(totaltrialnum).Feedback = 0;
           else
               NetStation('Event', MarkerWrongResponse);
                WaitSecs(0.002);
                %outp(888, 0);
                Data(totaltrialnum).Feedback = 0;
            end  
...
%             
        ...
        Screen('Flip', wPtr);
        NetStation('Event', MarkerBlockEnd);
        WaitSecs(0.002);
         %outp(888, 0);
        WaitSecs(30);
